...
engine = pyttsx3.init()                            # Speech engine initialisation
...
webbrowser.register('chrome', None, 
                    webbrowser.BackgroundBrowser(chrome_path))             # Register the browser

appId = '5R49J7-J888YX9J2V'                   # Wolfram Alpha client
...
if __name__ == '__main__': 
    speak('Hello Iam simple AI What can i do for you ?', 150)
    ...
    while True:
        ...
        if query[0] == activationWord:
            ...
            if query[0] == 'say':
                if 'hello' in query:
                    speak('Hello glad to talk with you')
                else:
